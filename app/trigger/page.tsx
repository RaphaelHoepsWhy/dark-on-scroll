import { Card } from "@/components/triggered-colors/Card"
import TriggerDark from "@/components/triggered-colors/TriggerDark"
import Link from "next/link"

export default function Home() {
  return (
    <div className="min-h-screen bg-white text-neutral-950 transition-colors duration-700 ease-in-out dark:bg-neutral-950 dark:text-neutral-200">
      <main className="mx-auto max-w-6xl px-6 py-16">
        {/* Hero Section */}
        <section className="mb-24">
          <h1 className="mb-6 text-5xl font-bold tracking-tight md:text-7xl">
            Trigger Dark On Scroll
          </h1>
          ...
          <Link href="./instant">Dynamic Change On Scroll</Link>
        </section>
